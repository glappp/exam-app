// ข้อมูลจังหวัดและอำเภอของประเทศไทย (77 จังหวัด)
const THAILAND_GEO = {
  "กรุงเทพมหานคร": ["เขตพระนคร","เขตดุสิต","เขตหนองจอก","เขตบางรัก","เขตบางเขน","เขตบางกอกน้อย","เขตบางกอกใหญ่","เขตห้วยขวาง","เขตบึงกุ่ม","เขตตลิ่งชัน","เขตบางซื่อ","เขตจตุจักร","เขตบางเขน","เขตดอนเมือง","เขตราษฎร์บูรณะ","เขตหลักสี่","เขตลาดกระบัง","เขตยานนาวา","เขตสัมพันธวงศ์","เขตพระโขนง","เขตมีนบุรี","เขตลาดพร้าว","เขตวังทองหลาง","เขตคลองสาน","เขตตลาดพลู","เขตธนบุรี","เขตบางมด","เขตบางแค","เขตหลักสี่","เขตลาดพร้าว","เขตสวนหลวง","เขตคลองเตย","เขตสาทร","เขตบางนา","เขตทวีวัฒนา","เขตทุ่งครุ","เขตบางบอน","เขตภาษีเจริญ","เขตหนองแขม","เขตราษฎร์บูรณะ","เขตหลักสี่","เขตลาดกระบัง","เขตสาทร","เขตบึงกุ่ม","เขตสาทร","เขตลาดพร้าว","เขตบางรัก","เขตป้อมปราบศัตรูพ่าย","เขตพระโขนง","เขตมีนบุรี"],
  ...
  "ฉะเชิงเทรา": ["เมืองฉะเชิงเทรา","คลองเขื่อน","บางน้ำเปรี้ยว","บางปะกง","บ้านโพธิ์","พนมสารคาม","ราชสาส์น","สนามชัยเขต","แปลงยาว","ท่าตะเกียบ","บางคล้า"],
  ...
  "นครราชสีมา": ["เมืองนครราชสีมา","ครบุรี","เสิงสาง","คง","บ้านเหลื่อม","จักราช","โชคชัย","ด่านขุนทด","โนนไทย","โนนสูง","ขามสะแกแสง","บัวใหญ่","ประทาย","ปักธงชัย","พิมาย","ห้วยแถลง","ชุมพวง","วังน้ำเขียว","เตรียมอุดมศึกษา","บัวลาย","สีดา","เฉลิมพระเกียรติ","เมืองยาง","พระทองคำ","ลำทะเมนชัย","บ้านเหลื่อม","เนินสูง","ขามทะเลสอ","สูงเนิน","ทับสนุก","ปากช่อง","หนองบุญมาก"],
  ...
  "สระบุรี": ["เมืองสระบุรี","แก่งคอย","หนองแค","วิหารแดง","หนองแซง","บ้านหมอ","ดอนพุด","หนองโดน","พระพุทธบาท","สระโบสถ์","วังม่วง","เฉลิมพระเกียรติ","บ้านหมอ"],
  ...
  "หนองบัวลำภู": ["เมืองหนองบัวลำภู","นากลาง","โนนสัง","ระดู","สุวรรณคูหา","นาวัง"],
