// upload-ipst-p6-2556-images.js
// อัปโหลดรูปภาพโจทย์สสวท ป.6 2556 ขึ้น Cloudflare R2
// รัน: node server/prisma/upload-ipst-p6-2556-images.js
...
const R2_FOLDER = 'p6-ipst-2556';

const PIC_DIR = 'C:\\Users\\patta\\Downloads\\โครงการพัฒนาอัจฉริยภาพทางวิทยาศาสตร์และคณิตศาสตร์ สสวท\\56\\pic';

const IMAGES = [
  '19.png', '20.png', '21.png', '22.png', '23.png',
  '24.png', '25.png', '26.png', '27.png',
  '32.png', '33.png', '34.png',
  '36.png', '37.png', '38.png', '40.png',
];
