...
# P4 questions (677 ข้อ — seeded ใน schema redesign + old seeds)
# P5 questions (seed ไฟล์ใน server/prisma/seed-questions-*-p5.js)
node prisma/seed-questions-fractions-p5.js      # 60 ข้อ (add-unlike, multiply, divide)
node prisma/seed-questions-decimals-p5.js       # 40 ข้อ (multiply, divide)
node prisma/seed-questions-percentage-p5.js     # 80 ข้อ (concept, convert, of-amount, word-problem)
node prisma/seed-questions-geometry-p5.js       # 20 ข้อ (circle)
node prisma/seed-questions-area-volume-p5.js    # 40 ข้อ (area-rectangle, area-word-problem)
node prisma/seed-questions-statistics-p5.js     # 40 ข้อ (line-chart, mean)
# P6 questions (seed ไฟล์ใน server/prisma/seed-questions-*-p6.js)
node prisma/seed-questions-ratio-p6.js                   # 80 ข้อ (concept, simplify, proportion, word-problem)
node prisma/seed-questions-geometry-p6.js                # 20 ข้อ (coordinate)
node prisma/seed-questions-area-volume-p6.js             # 100 ข้อ (triangle, parallelogram, trapezoid, combined, cuboid)
node prisma/seed-questions-statistics-p6.js              # 20 ข้อ (pie-chart)
node prisma/seed-questions-order-of-operations-p6.js     # 80 ข้อ (bodmas-basic, brackets, mixed, word-problem)
```
...
| Grade | ข้อ | Topics |
|-------|-----|--------|
| P4 | 677 | whole-numbers (7), fractions (6), decimals (6), geometry (5), measurement (6), statistics (4) |
| P5 | 280 | fractions (3), decimals (2), percentage (4), geometry-circle (1), area-volume (2), statistics (2) |
| P6 | 300 | ratio (4), geometry-coordinate (1), area-volume (5), statistics-pie-chart (1), order-of-operations (4) |
| **รวม** | **1,257** | |

- ทุก subtopic มี 20 ข้อ
- `examGrade` เป็น string `'p4'`/`'p5'`/`'p6'` ทุกข้อ (fix แล้ว 2026-04-11)
- subtopic key รูปแบบ `subtopic:xxx-yyy` ทุกข้อ
